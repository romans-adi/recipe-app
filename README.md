...
Introducing the Ultimate Recipe Assistant: Your all-in-one solution for effortless cooking! Seamlessly organize your recipes, ingredients, and pantry items. Craft delicious recipes with ease, generate smart shopping lists, and even share your culinary creations with the world. Cooking has never been this convenient – simplify your kitchen adventures with our Recipe app!
...
```
git clone git@github.com:romans-adi/recipe-app.git
```
Using HTTPS:

```
git clone https://github.com/romans-adi/recipe-app.git
```

You can also create the new directory just adding the name of it in the end of command. For example:

```
git clone https://github.com/romans-adi/recipe-app.git recipe-app
```
